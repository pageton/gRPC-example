...
class ImageProcessorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessImage = channel.unary_unary(
                '/service.ImageProcessor/ProcessImage',
...
def add_ImageProcessorServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'service.ImageProcessor', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('service.ImageProcessor', rpc_method_handlers)
